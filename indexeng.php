...
<body>
	...
	<!-- /.navbar -->
<div id="header">
<h4 align="center"><b>Upload English for primary learning resources here</b></h4>
</div>
<div align="center">
<div id="body">
	<form action="uploadeng.php" method="post" enctype="multipart/form-data">
	...
	<?php if (isset($message)){ echo $message;} ?>
					<form method="post">
						<div align="center" class="col-md-3 col-md-offset-4 form-group">
							...
							<a href="viewadmineng.php">click here to view already uploades files.</a>
						</div>
	...
	{
		?>
        <label>File Uploaded Successfully...  <a href="viewadmineng.php">click here to view file.</a></label>
        <?php
	}
