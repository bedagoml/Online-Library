...
<head>
	...
	<title>free-educational webAPP</title>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				...
				<!-- 	<li><a href="price.html">Price</a></li>
					...
					<li><a href="select.php">upload files</a></li>
	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							<h1 class="animated flipInY delay1">Administrator's dashboard</h1>
							<p>Here administrator is able to upload files amd delete files that are nolonger in use</p>
						</div>
